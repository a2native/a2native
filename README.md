...
> a2native's input format is conceptually inspired by A2UI (flat component list, declarative)
> but adapted for synchronous stdin/stdout CLI use — it is **not** an implementation of the
